...
class BDistWheelBranch(bdist_wheel):
    ...
    will generate
        ./dist/aicscytoparam-<version>.dev<#>.feature_some_new_idea-<python-versions>-<arch>.whl
